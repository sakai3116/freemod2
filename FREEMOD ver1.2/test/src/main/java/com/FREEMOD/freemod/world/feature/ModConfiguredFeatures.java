...
public class ModConfiguredFeatures {
    ...
    public static final Holder<PlacedFeature> OBLIVION_CHECKED = PlacementUtils.register("oblivion_checked", OBLIVION_TREE,
            PlacementUtils.filteredByBlockSurvival(BlockRegister.OBLIVION_SAPLING.get()));
    ...
    public static final List<OreConfiguration.TargetBlockState> OVERWORLD_PLATINUM_ORES = List.of(
            OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, BlockRegister.PLATINUM_ORE.get().defaultBlockState()),
            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, BlockRegister.DEEPSLATE_PLATINUM_ORE.get().defaultBlockState()));
