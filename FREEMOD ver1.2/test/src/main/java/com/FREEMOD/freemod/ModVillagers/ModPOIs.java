package com.FREEMOD.freemod.ModVillagers;
...
public class ModPOIs {
    ...
    public static final RegistryObject<PoiType> OBLIVION_PORTAL =
            POI.register("oblivion_portal",() -> new PoiType("oblivion_portal", PoiType.getBlockStates(ModBlocks.OBLIVION_PORTAL_BLOCKS.get()),0,1));
